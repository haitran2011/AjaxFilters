...
namespace Spikes.Nop.Plugins.AjaxFilters.Areas.Admin.Extensions
{
	public static class SpecificationAttributeServiceExtensions
	{
		...
		{
			return EngineContext.Current.Resolve<IRepository<SpecificationAttribute>>().Table.Where((SpecificationAttribute sa) => sa.Name.Equals(name, StringComparison.InvariantCulture)).FirstOrDefault();
		}
