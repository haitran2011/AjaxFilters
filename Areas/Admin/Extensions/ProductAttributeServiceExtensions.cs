...
namespace Spikes.Nop.Plugins.AjaxFilters.Areas.Admin.Extensions
{
	public static class ProductAttributeServiceExtensions
	{
		...
		{
			return EngineContext.Current.Resolve<IRepository<ProductAttribute>>().Table.Where((ProductAttribute sa) => sa.Name.Equals(name, StringComparison.InvariantCulture)).FirstOrDefault();
		}
