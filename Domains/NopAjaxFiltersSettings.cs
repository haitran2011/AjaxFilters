...
namespace Spikes.Nop.Plugins.AjaxFilters.Domain
{
	public class NopAjaxFiltersSettings : ISettings
	{
		...
		public string EncryptedDatabaseHashKey
		{
			get;
			set;
		}

		public bool DropSortFunctionDuringUpdate
		{
			get;
			set;
		}
		...
		public bool PrepareSpecificationAttributes
		{
			get;
			set;
		}
		...
		public int ScrolltoElementAfterFiltrationAdditionalOffset
		{
			get;
			set;
		}

		public List<string> ActiveProductAttributes
		{
			get;
			set;
		}

		public List<int> SpecificationAttributeSliders
		{
			get;
			set;
		}
