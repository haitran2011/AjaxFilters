FiltersManager = function() {
    ...
    function(b, w, A) {
        ...
        b.fn.extend({
            ...
            if (!A.waitForAjaxRequest && "#/noFilterApplied" !== p) {
                ...
                var l = this.getSpecificationFiltersModel(),
					...
					hai = this.getCategoryFiltersModel(),
                    n = this.getManufacturerFiltersModel(),
                    d = this.getVendorFiltersModel(),
					suong = this.getRatingFiltersModel(),
                ...
                var m = {
					...
					categoryFiltersModel7Spikes: hai,
					...
					ratingFiltersModel7Spikes: suong,
                    onSaleFilterModel: h,
            ...
            return this.buildCategoryFiltersModel(this.categoryId, this.selectedFilterGroupElement)
        ...
        },  A.prototype.getRatingFiltersModel = function() {
            return this.buildRatingFiltersModel(this.categoryId, this.selectedFilterGroupElement)
            ...
            e.find("a").each(function() {
                ...
                b(this).removeAttr("href"), b(this).attr("data-pageNumber", t), b(this).click({
                    filtersManager: i
                }, d)
            })
			...
			var l1 = b(e).filter("#categoryFilterModel7SpikesJson").val().toString(),
                s1 = l1 ? b.parseJSON(l1) : null;
			t.refreshCategoryFilters(s1, t.filtersUIMode);
			...
			var c1 = b(e).filter("#ratingFilterModel7SpikesJson").val().toString(),
                p = c1? b.parseJSON(c1) : null;
            t.refreshRatingFilters(p, t.filtersUIMode);
        ...
        }, A.prototype.clearPriceRangeFilterControl = function() {}, A.prototype.refreshCategoryFilters = function() {},A.prototype.refreshManufacturerFilters = function() {}, A.prototype.refreshVendorFilters = function() {}, A.prototype.refreshSpecificationFilters = function() {}, A.prototype.refreshAttributeFilters = function() {}, A.prototype.refreshRatingFilters = function() {},A.prototype.refreshOnSaleFilters = function() {}, A.prototype.refreshInStockFilters = function() {}, A.prototype.buildCategoryFiltersModel = function() {},A.prototype.buildManufacturerFiltersModel = function() {}, A.prototype.buildVendorFiltersModel = function() {}, A.prototype.buildSpecificationFiltersModel = function() {}, A.prototype.buildAttributeFiltersModel = function() {}, A.prototype.buildRatingFiltersModel = function() {},A.prototype.buildOnSaleFiltersModel = function() {}, A.prototype.addProductPanelAjaxBusyToPage = function() {
            var e = c();
        ...
        }, A.addStateClassAndAttributesToOption = function(e, t, r,filterCount) {
            var i = !1;
			$('span[for=' + $(e).attr('id') + ']').text(jQuery.validator.format("({0})", filterCount));
